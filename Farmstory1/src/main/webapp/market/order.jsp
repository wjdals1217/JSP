        ...
        <article class="order">
            ...
            <div class="info">
                ...
                <table border="0">                            
                    ...
                    <tr>
                        <td>배송비</td>
                        <td class="delivery"><%=Utils.comma(delivery) %></td>
                    </tr>
                    <tr>
                        <td>판매가격</td>
                    ...
                    <tr>
                        <td>구매수량</td>
                        <td class="count"><%=Utils.comma(count) %>개</td>
                    </tr>
                    <tr>
                        <td>최종합계</td>
               ...
               <form id="formOrder" action="/Farmstory1/market/proc/orderProc.jsp" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td>배송주소</td>
                        <td>
                            <input type="text" name="zip" value="<%=sessUser.getZip()%>" readonly><button id="btnZip">우편번호 검색</button>
