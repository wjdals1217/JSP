...
<main>
    ...
    <section id="orderList">
        ...
        <article>
            ...
            <p class="paging">
                <% if(pageGroupStart > 1){ %>
	            <a href="./orderList.jsp?cate=order&pg=<%= pageGroupStart - 1 %>" class="prev"><</a>
	            <% } %>
	            
	            <% for(int i=pageGroupStart ; i<=pageGroupEnd ; i++){ %>
	            <a href="./orderList.jsp?cate=order&pg=<%= i %>" class="<%= (currentPage == i)?"on":"" %>">[<%= i %>]</a>
	            <% } %>
	            
	            <% if(pageGroupEnd < lastPageNum){ %>
	            <a href="./orderList.jsp?cate=order&pg=<%= pageGroupEnd + 1 %>" class="next">></a>
	            <% } %>
            </p>
        </article>
    </section>
