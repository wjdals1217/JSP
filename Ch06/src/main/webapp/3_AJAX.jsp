...
<html>
	...
	<body>
		...
		<h4>JSON/XML 실습</h4>
		<a href="./data/json1.jsp">JSON1 데이터 생성</a><br>
		<a href="./data/json2.jsp">JSON2 데이터 생성</a><br>
		<a href="./data/xml1.jsp">XML1 데이터 생성</a><br>
		<a href="./data/xml2.jsp">XML2 데이터 생성</a><br>
